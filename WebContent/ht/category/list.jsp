...
<body>
    ...
    <div class="tools">    
    	<ul class="toolbar">
        <li class="click"><a href="${path }ht/category/add.jsp"><span><img src="images/t01.png" /></span>添加信息类别</a></li>
        </ul>
       </div>
				...
				<tbody>	
					<s:iterator value="list" id="category">	
						<tr>
							...
							<td><a
								href='${path}ht/editCategory.action?cid=<s:property value="#category.cid"/>'
	    ...
	    <script type="text/javascript">
			function del(cid){
				...
				{
				   location.href="${path}ht/delCategory.action?cid="+cid;
				 }
			}
		</script>
    </div>
