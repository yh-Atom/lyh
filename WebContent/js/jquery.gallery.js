		...
		_getCoordinates		: function( position ) {
			...
			if( this.support3d && this.supportTrans ) {
				...
				switch( position ) {
					...
					case 'left':
						return {
							'-webkit-transform'	: 'translateX(-350px) translateZ(-380px) rotateY(45deg)',
							'-moz-transform'	: 'translateX(-350px) translateZ(-380px) rotateY(45deg)',
							'-o-transform'		: 'translateX(-350px) translateZ(-380px) rotateY(45deg)',
							'-ms-transform'		: 'translateX(-350px) translateZ(-380px) rotateY(45deg)',
							'transform'			: 'translateX(-350px) translateZ(-380px) rotateY(45deg)',
							'opacity'			: 1,
							'visibility'		: 'visible'
						};
						break;
